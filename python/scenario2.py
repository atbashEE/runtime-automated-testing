...
"""
Start Runtime with 1 application. After Health endpoints is ok, it checks if the application is indeed accessible.
It checks following info
- Console log contain the correct entries
- Log file contains the expected entries, including the listing of available endpoints within the application
- It checks if applications.json is present and contains the expected values.
"""
if __name__ == '__main__':
    ...
    clean_up()
    print("Scenario 2 testing completed successfully")
