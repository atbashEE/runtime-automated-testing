...
"""
Start the runtime as Daemon process, wait until the health endpoint says it is ready
Check the application call, and stop the process through the runtime-cli.  
"""
if __name__ == '__main__':
    print("Launch Runtime as daemon with application")
    runner = AtbashRunner()
    output = runner.launch_runtime_no_wait(["-d", "demo-rest.war"])
    ...
    # The daemon process was just started, not waited until health endpoint says Runtime is ready.
    # So do it now
    ...
    clean_up()
    print("Scenario 16 testing completed successfully")
